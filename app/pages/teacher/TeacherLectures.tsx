        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-lg p-6 bg-white shadow-xl relative">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div><label className="text-sm font-medium text-[#0B2A5B]">Google Meet / Zoom Link</label><Input type="url" placeholder="Leave blank to auto-generate Google Meet" value={newLecture.meeting_link} onChange={(e) => setNewLecture({ ...newLecture, meeting_link: e.target.value })} className="bg-[#F4F1EA]" /></div>
